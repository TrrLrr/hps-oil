...
let plugins = [
  ...
  new DefinePlugin({
    ...
    __AWS_ACCESS_KEY__: JSON.stringify(process.env.AWS_ACCESS_KEY),
    __AWS_SECRET_ACCESS_KEY__: JSON.stringify(process.env.AWS_SECRET_ACCESS_KEY),
    __AWS_BUCKET__: JSON.stringify(process.env.AWS_BUCKET)
...
module.exports = {
  ...
  module: {
    rules: [
      ...
      {
        test: /\.(mp3|png|aac|aiff|wav|flac|m4a|mp4|ogg)$/,
        exclude: /\.glyph.svg/,
        use: [
          {
            loader: 'file-loader',
